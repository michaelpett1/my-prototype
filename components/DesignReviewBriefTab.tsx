...
interface DesignReviewBriefTabProps {
  content: string;
  onContentChange: (content: string) => void;
}

export default function DesignReviewBriefTab({ content, onContentChange }: DesignReviewBriefTabProps) {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <p className="text-sm text-gray-500">
            Send this to the reviewer/designer for sign-off
          </p>
          {isEdited && (
